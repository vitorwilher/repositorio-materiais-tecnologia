---
title: "Linux para Profissionais de TI"
subtitle: "40h · Trilha 3 — Infraestrutura, Cloud e Redes"
---

::: {.callout-note appearance="simple"}
**Status:** <span class="status-pill status-novo">novo</span> &nbsp; novo — proposta a validar (GT Tech) · Código: NC-07
&nbsp;·&nbsp; **Carga horária:** 40h &nbsp;·&nbsp; **Origem:** Proposta 2027 — pré-requisito DevOps
