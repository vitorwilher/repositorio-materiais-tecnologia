---
title: "Cloud Fundamentos com Azure"
subtitle: "40h · Trilha 3 — Infraestrutura, Cloud e Redes"
---

::: {.callout-note appearance="simple"}
**Status:** <span class="status-pill status-novo">novo</span> &nbsp; novo — proposta a validar (GT Tech) · Código: NC-08
&nbsp;·&nbsp; **Carga horária:** 40h &nbsp;·&nbsp; **Origem:** Proposta 2027 — gap Azure
