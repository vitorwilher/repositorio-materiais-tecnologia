---
title: "Programação Avançada em Python com IA"
subtitle: "100h · Trilha 5 — Programação e Desenvolvimento"
---

::: {.callout-note appearance="simple"}
**Status:** <span class="status-pill status-ativo">ativo</span> &nbsp; ativo no catálogo
&nbsp;·&nbsp; **Carga horária:** 100h &nbsp;·&nbsp; **Origem:** Catálogo público — ponte para Dados
