...
subtitle: "24h · Trilha 2 — Dados, Trilha 5 — Programação e Desenvolvimento"
---

::: {.callout-note appearance="simple"}
**Status:** <span class="status-pill status-novo">novo</span> &nbsp; novo — proposta a validar (GT Tech) · Código: NC-01
&nbsp;·&nbsp; **Carga horária:** 24h &nbsp;·&nbsp; **Origem:** Proposta — isca comum
...
Faz parte de: [Trilha 2 — Dados](../../trilhas/trilha-2-dados.qmd) · [Trilha 5 — Programação e Desenvolvimento](../../trilhas/trilha-5-programacao.qmd).
